        ...
        <div className="container px-4 md:px-6">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
            ...
            <p className="max-w-[85%] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Real-world platforms I've built - spanning professional systems,
            ...
            <Sheet open={showFilters} onOpenChange={setShowFilters}>
                ...
                <Button variant="outline" size="sm" className="relative">
                  ...
                  {isFiltered && (
                    <span className="absolute -top-2 -right-2">
                      <Badge
                        variant="default"
                        className="rounded-full px-2 py-0.5 text-[10px] h-auto"
                      >
                        ●
                      </Badge>
                    </span>
              ...
              <SheetContent
                ...
                className={`${
                  isMobile
                    ? "w-screen"
                    : "w-[90vw] max-w-sm md:max-w-md lg:max-w-lg"
                }`}
              >
                <SheetHeader>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {categories.map((cat, i) => (
                        <Button
                          key={i}
                          variant={
                            cat === filterCategory ? "default" : "outline"
                          }
                          size="sm"
                    ...
                    <div className="flex flex-wrap gap-2">
                      {statuses.map((status, i) => (
                        <Button
                          key={i}
                          variant={
                            status === filterStatus ? "default" : "outline"
                          }
                          size="sm"
              ...
              visibleProjects.map((project, index) => (
                ...
                >
                  ...
                  <CardFooter className="justify-between">
                    ...
                    >
                      <Code className="mr-2 h-4 w-4 text-primary" /> View
                      Details
                    </Button>
                  </CardFooter>
                </Card>
