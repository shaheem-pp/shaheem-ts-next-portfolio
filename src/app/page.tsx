          ...
          <div className="mx-auto max-w-[85%]">
            ...
            <blockquote className="mx-auto max-w-3xl text-center">
              <p className="text-xl md:text-2xl italic leading-relaxed">
                "I've had the pleasure of working with Shaheem, and he's been an
                invaluable part of our team. His expertise in Django,
                problem-solving mindset, and dedication to writing clean,
                efficient code make him a standout developer. Beyond his
                technical skills, he's a great team player who's always
                proactive and eager to improve."
              </p>
              <footer className="mt-6">
                <div className="font-semibold">Shahin Abdulla</div>
                <div className="text-white/80 text-sm">
                  Co-Founder and CPO of Agua India
                </div>
              </footer>
            </blockquote>
          </div>
