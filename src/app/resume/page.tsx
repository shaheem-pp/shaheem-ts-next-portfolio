					...
					<div className="max-w-5xl mx-auto space-y-6">
						...
						<div className="grid gap-6">
							{experiences.map((exp, index) => (
								<Card key={index}>
									<CardHeader>
										<div className="text-primary font-medium text-xl">{exp.company}</div>
										<div className="text-sm text-muted-foreground">{exp.location}</div>
									</CardHeader>
									<CardContent className="space-y-6">
										{exp.positions ? (
											// Timeline view for multiple positions
													...
													<div
														...
														className={`relative ${
															posIndex !== exp.positions!.length - 1
																? "pb-6 border-l-2 border-border pl-6 ml-2"
																: "pl-6 ml-2"
														}`}
													>
														{/* Timeline dot */}
											...
											// Single position view (legacy support)
											<>
								...
								>
									<Card className="overflow-hidden hover:shadow-lg transition-shadow duration-200 h-full">
										...
										<CardHeader>
											...
											{achievement.role && (
												<div className="text-sm font-medium text-primary">{achievement.role}</div>
											)}
										</CardHeader>
										<CardContent>
