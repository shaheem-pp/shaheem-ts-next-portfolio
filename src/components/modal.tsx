      ...
      <Dialog as="div" className="relative z-50" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-4xl h-[90vh] overflow-hidden rounded-2xl bg-white dark:bg-zinc-900 text-left align-middle shadow-xl transition-all flex flex-col">
                {/* Sticky Header */}
                <div className="sticky top-0 z-10 bg-white dark:bg-zinc-900 text-gray-900 dark:text-gray-100 p-6 border-b dark:border-zinc-700 flex justify-between items-stretch">
                  <div>
